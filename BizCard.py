...
with tab1:
    ...
    # --------------------------------------   /   Data Upload to Mysql   /   --------------------------------------- #
        ...
        if session_state.data_uploaded:
            ...
            connect = pymysql.connect(host="127.0.0.1", user="root", password="dhanushd")
            ...
            engine = create_engine('mysql+pymysql://root:dhanushd@localhost/bizcard_db', echo=False)
            #mysql+mysqlconnector://username:password@localhost/dbname?auth_plugin=mysql_native_password

            try:
                # Use pandas to insert the DataFrame data into the SQL Database
...
with tab2:
    ...
    with col1:
        ...
        try:
            ...
            conn = pymysql.connect(host="127.0.0.1", user="root", password="dhanushd", database="bizcard_db")
    ...
    with col2:
        ...
        try:
            # Connect to the database
            conn_del = pymysql.connect(host="127.0.0.1",user="root", password="dhanushd", database="bizcard_db")
